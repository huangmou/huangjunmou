package com.jason.feick.download;
...
import com.jason.feick.util.SdcardHelper;
import com.jason.feick.util.ToastUtil;
import com.jason.feick.net.MyHttpConnection;
...
//				ToastUtil.initToast(DownloadService.this).showToast("sd卡空间不足");
	...
	private void startDownLoad(final DownLoadQueue queue) {
		new Thread() {
			public void run() {
				try {
					HttpClient client = MyHttpConnection.getHttpClient();
