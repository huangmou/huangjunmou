...
public final class JsonParseHelper
{
  ...
  public static MyJsonMap getJsonMap(String jsonString)
  {
    MyJsonMap valueMap;
    try
    {
  ...
  public static List<MyJsonMap> getList_JsonMap(String jsonString)
  {
    List list = null;
    try {
      JSONArray jsonArray = new JSONArray(jsonString);
  ...
  public static MyJsonMap getJsonMap_JsonMap(String jsonString, String key)
  {
    MyJsonMap map = getJsonMap(getAttribute(jsonString,
      new String[] { key }));
    return map;
  }

  public static List<MyJsonMap> getJsonMap_List_JsonMap(String jsonString, String key)
  {
    return getList_JsonMap(getAttribute(jsonString, new String[] { key }));
  }

  public static List<MyJsonMap> getJsonMap_JsonMap_List_JsonMap(String jsonString, String key, String key_key)
  {
    return getList_JsonMap(getAttribute(jsonString, new String[] { key, 
      key_key }));
  }
